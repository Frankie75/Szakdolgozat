        ...
        private void btnAction_Click(object sender, EventArgs e)
        {
            ...
            switch (action)
            {
                case actions.newUser:
                    ...
                    if(Users.Count >= 10)
                    {
                        MessageBox.Show("A fehlasználók maximalis száma: 10 db.");
                        break;
                    }
                ...
                case actions.deleteUser:
                    ...
                    {
                        MessageBox.Show("Az 'admin' felhasználo nem törölhető!");
                        break;
                    }
                    ...
                    foreach (var item in Users)
                    {
                        ...
                        if (item.Name == tbUserName.Text)
                        {
                            if (EncryptDecrypt(item.Password, 1) == tbPassword.Text)
                            {
                                ...
                                MessageBox.Show("Felhasznáaló törölve");
                                this.Close();
                ...
                case actions.changePassword:
                    ...
                    {
                        MessageBox.Show("Az új jelszó hossza 4-8 karakter kell, hogy legyen!");
                        break;
                    }
